    ...
    methods: {
        ...
        update: function () {
            ...
            $.get(baseURL + "sys/menu/info/"+menuId, function(r){
                ...
                vm.title = "修改";
                vm.menu = r.menu;
                console.log("vm.menu:" + vm.menu.parentId);
                console.log("r.menu:" + r.menu.parentId)
        ...
        menuTree: function(){
            layer.open({
                ...
                btn2: function (index) {
                    ...
                    console.log("menuTree" + node[0].menuId);
...
Menu.initColumn = function () {
    var columns = [
        ...
        {title: '菜单ID', field: 'menuId', visible: false, align: 'center', valign: 'middle', width: '180px'},
