...
public class ClassUtil {
    ...
    public static void main(String[] args) {
        ...
        // 包下面的类
        Set<Class<?>> clazzs = getClasses("dc.platform.admin.modules.sys.entity");
        if (clazzs == null) {
            return;
        }
        ...
        for (Class<?> clazz : clazzs) {
            ...
            for (Field declaredField : declaredFields) {
                boolean fieldHasAnno = declaredField.isAnnotationPresent(TableId.class);
                if (fieldHasAnno) {
                    System.out.println(
                            "class:" + clazz.getSimpleName() +
//                            " fieldAnnotation :" + declaredField.getAnnotationsByType(TableId.class) +
