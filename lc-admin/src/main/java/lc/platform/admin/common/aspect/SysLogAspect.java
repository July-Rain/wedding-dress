...
import lc.platform.admin.common.utils.HttpContextUtils;
import lc.platform.admin.common.utils.IPUtils;
...
public class SysLogAspect {
	...
	@Pointcut("@annotation(lc.platform.admin.common.annotation.SysLog)")
	...
	private void saveSysLog(ProceedingJoinPoint joinPoint, long time) {
		...
		//用户名
		String username = ((SysUserEntity) SecurityUtils.getSubject().getPrincipal()).getNickName();
