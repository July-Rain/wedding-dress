...
public class ModelUtil {
    ...
    /**
     * get resultset data ,mapping to Map
     * @param resultSet
     * @return
     * @throws SQLException 
     */
    public static List<Map<String, Object>> dbEntity2Map(ResultSet resultSet) throws SQLException{
    	...
    	if (resultSet==null) {
			...
			while (resultSet.next()) {
				...
				for (int i = 1; i <= total; i++) {
					...
					map.put(dbNameToVarName(columnLabelName), resultSet.getObject(i));
				}
				list.add(map);
			}
		}
     ...
     */
//    public noLock String replaceString(String mainString, String oldString, String newString) {
//        return StringUtil.replaceString(mainString, oldString, newString);
//    }

//    public noLock String induceFieldType(String sqlTypeName, int length, int precision, ModelFieldTypeReader fieldTypeReader) {
